...
/** Base implementation of the [[YearMonthField]] LinkML class
  * 
  * @inheritdoc
  */
case class YearMonthFieldImpl(
    @named("type")
...
) extends YearMonthField 


abstract class YearMonthField extends FieldDescriptor {
